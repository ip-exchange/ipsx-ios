...
class ProxyDetailsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let proxyDetails = ProxyActivationDetails(startDate: Date(), endDate: Date(), country: "Spain", userIP: "192.32.50.101", remainingMB: "10", remainingDuration: "20 min", status: "active".localized)
