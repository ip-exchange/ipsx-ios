...
public struct Url {
    ...
    public static let proxyPackagesArgs     = "/packages?filter[where][cost][gt]=0&filter[where][user_id]=1&filter[where][status]=active&filter[where][deleted_at]=null?access_token=%ACCESS_TOKEN%"
    public static let proxyTestPackageArgs  = "/packages?filter[where][cost]=0&filter[where][user_id]=1&filter[where][status]=active&filter[where][deleted_at]=null?access_token=%ACCESS_TOKEN%"
